...
const ClientDetailView = ({ client, onBack, onDelete, onOpenQuickLog, refreshKey }) => {
  ...
  return (
    <div className="relative flex h-dvh min-h-0 flex-col overflow-hidden bg-[#0a0a0a] animate-slide-up">
      ...
      <div className="relative z-20 shrink-0 px-4 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] pt-3">
        <div className="flex w-full justify-between rounded-[32px] border border-white/10 bg-black/80 p-1.5 shadow-2xl shadow-black/40 backdrop-blur-3xl">
          {[
