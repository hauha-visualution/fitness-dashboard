...
import { UserPlus, ChevronRight, Users, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="h-screen flex flex-col relative z-10 bg-gradient-to-b from-[#2a2a2c] via-[#121212] to-[#000000] px-6 py-8 pb-32 overflow-y-auto hide-scrollbar">
      <div className="flex justify-between items-center mb-8 shrink-0">
         ...
         <button onClick={onOpenAdd} className="p-3 bg-white text-black rounded-full shadow-lg hover:scale-105 transition-all"><UserPlus className="w-5 h-5" /></button>
      </div>
