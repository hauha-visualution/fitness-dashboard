      ...
      <div className="px-6 mb-8 shrink-0">
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex gap-2">
            <button onClick={prevMonth} className="p-2 bg-white/[0.05] rounded-full"><ChevronLeft className="w-4 h-4 text-white"/></button>
            <button onClick={nextMonth} className="p-2 bg-white/[0.05] rounded-full"><ChevronRight className="w-4 h-4 text-white"/></button>
          </div>
        </div>
